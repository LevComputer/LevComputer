...
Route::post('/newsletter/save', 'App\Http\Controllers\newsletterController@save')->name('newsletter_save');
Route::get('/newsletter/manage', 'App\Http\Controllers\newsletterController@manage')->name('manage_newsletter');
//========= Newsletter End Here =========//
//   ========= BackEnd End Here =========   //