...
@section('content')
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter="*" class="filter-active">LAYANAN PERBAIKAN</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row portofolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item">
            <img src="{{ $computer->computer_image }}" class="img-fluid" style="width: 400px; height: 400px">

            <div class="portfolio-info" style="width: 300px;">
                        ...
                        <div class="col-lg-12">
                          <div class="portfolio-info">
                            ...
                            <ul>
                              ...
                              <li><strong>Price</strong>: Mulai Dari Rp{{ $computer->full_price }}</li>
    ...
    <section class="parallax" style="background-color: maroon; color:white; padding-left:30px; padding-right:30px; text-align:center">
      <h4>"SALAH SATU KEUNGGULAN KAMI ADALAH KAMI MEMBANGUN KEPERCAYAAN DAN SELALU MEMBERIKAN PELAYANAN SUPPORT YANG CEPAT DENGAN TETAP MENJAGA KUALITAS LAYANAN YANG TERBAIK KEPADA KLIEN KAMI"</h4>
    </section>
            ...
            <div class="info-wrap">
              <div class="row">
                <div class="col-lg-4 info">
                  ...
                  <h4>Lokasi :</h4>
                  <p>Jl. Sahabat 5, Tamalanrea, Makassar</p>
                </div>
